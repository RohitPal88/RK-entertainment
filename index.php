...
<body>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Events</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li class="dropdown"><a href="#"><span>Wedding</span> <i
                                        class="bi bi-chevron-right"></i></a>
                                <ul>
                                    <li><a href="#">Haldi ceremony</a></li>
                                    <li><a href="#">Mehendi ceremony</a></li>
                                    <li><a href="#">Engagement ceremony</a></li>
                                    <li><a href="#">Jaimala</a></li>
    ...
    <section id="hero">
        <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
            <h1 class="mb-4 pb-0">The Intro<br><span><?= SITE_NAME ?></span></h1>
            <p class="mb-4 pb-0"><?= SITE_ADDRESS ?>, <?= SITE_AREA ?>, <?= SITE_CITY ?>, <?= SITE_STATE ?> -
                <?= SITE_PIN ?>
            </p>
            <a href="<?= SITE_INTRO ?>" class="glightbox play-btn mb-4"></a>
    ...
    <main id="main">
        ...
        <section id="manager">
            <div class="container" data-aos="fade-up">
                <div class="section-header">
                    <h2>Event Manager</h2>
                    <!-- <p>Here are some of our managers</p> -->
                </div>
                ...
                <div class="row" style="justify-content: center;">
                    <div class="col-lg-4 col-md-6">
                        <div class="speaker" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="details">
                                <h3><a href="speaker-details.html">Parth</a></h3>
...
<div class="container-fluid" data-aos="fade-up">
    ...
    <div class="section-header">
        ...
        <p>Please find below office location</p>
    </div>
    ...
    <footer id="footer">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 footer-info">
                        ...
                        <p>Your premier event planning partner, creating unforgettable experiences tailored to your vision. 🎉 From weddings to corporate events, we orchestrate every detail with precision and creativity. 💼 Let us turn your dreams into reality. ✨</p>
                    </div>
        ...
        <div class="container">
            <div class="copyright">
              <?= date('Y') ?>  &copy; Copyright <strong><?= SITE_NAME ?> </strong>. All Rights Reserved
            </div>
            <div class="credits">Designed by <a href="http://rohit-resume.42web.io/">Rohit Pal</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
